...
//    @RequestBody
    public static void getSignList_qa() throws Exception{
        ...
        HttpPost post = new HttpPost(HostAddress.QA_geecorder_ip+replyWorkSheet.url);
        ...
        jsonParam.put("serialNo", "tc3vhTKsG1");
        jsonParam.put("attachRef", "1547204587122");
        opDetail.put("fieldInfo",fieldInfo.toString());
        jsonParam.put("opDetail", opDetail.toString());
